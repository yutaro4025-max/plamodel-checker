...
echo   1. PowerShell 実行ポリシーの確認と設定
...
:: ============================================================
:: スクリプトのパスを設定（%~dp0 は末尾に \ が付くためそのまま連結）
:: ============================================================
set SCRIPT_A=%~dp0Script-A_Register.ps1
set SCRIPT_B=%~dp0Script-B_Notify.ps1
set SCRIPT_R=%~dp0WeeklyReport.ps1
set SCRIPT_DIR=%~dp0
...
:: ============================================================
:: タスクスケジューラ登録（PowerShell 一時スクリプト経由）
